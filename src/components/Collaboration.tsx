import { check, conversaSymbol } from "../assets"
...
export const Collaboration = () => {
    return (
        <Section crosses className="collaboration">
            <div className="container lg:flex">
                ...
                <div className="lg:ml-auto xl:w-[38rem] mt-4">
                    ...
                    <div className="wrapper mt-4 relative left-1/2 flex w-[22rem] aspect-square border border-n-6 rounded-full
                    -translate-x-1/2 scale-75 md:scale-100">
                        ...
                        rounded-full">
                            <div className="w-[6rem] aspect-square m-auto p-[0.2rem] bg-conic-gradient rounded-full">
                                ...
                                rounded-full">
                                    <img src={conversaSymbol} alt="brin" width={48} height={48} />
                                </div>
                            </div>
                        </div>
                        <ul>
                            {collabApps.map((item, index) => (
                                <li key={item.id} className={`absolute top-0 left-1/2 h-1/2 -ml-[1.6rem]
