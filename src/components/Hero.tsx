...
export const Hero = () => {
    ...
    return (
        <Section id="hero" className="pt-[12rem] -mt-[5.25rem]" crosses crossesOffset="
        lg:translate-y-[5.25rem]" customPaddings >
            <div className="container relative" ref={parallaxRef}>
                ...
                md:mb-20 lg:mb-[6rem]">
                    <h1 className="h1 mb-6">
                        ...
                        <span className="inline-block relative ">
                            Conversa{" "}
                            <img src={curve} alt="curve" className="absolute top-full
                            left-0 w-full xl:-mt-2" width={624} height={28} />
                        </span>
                    </h1>
                    <p className="body-1 max-w-3xl mx-auto mb-6 text-n-2 lg:mb-8">Unleash the power of AI within Conversa.
                        Upgrade your productivity with Conversa, the open AI chat app.
                    </p>
                ...
                xl:mb-24">
                    <div className="relative z-1 p-0.5 rounded-2xl bg-conic-gradient">
                        ...
                        md:aspect-[688/490] lg:aspect-[1024/490]">
                            <img src={robot} alt="AI" className="w-full scale-[1.7]
                            translate-y-[8%] md:scale-[1] md:-translate-y-[10%]
                            lg:-translate-y-[23%]" width={1024} height={490} />
                            <Generating className="absolute left-4 right-5 bottom-5 md:left-1/2
                ...
                md:w-[138%] lg:-top-[54%]">
                    <img src={heroBackground} alt="hreoBg" width={1440} height={1800} />
                </div>
                <BackgroundCircles />
            </div>
